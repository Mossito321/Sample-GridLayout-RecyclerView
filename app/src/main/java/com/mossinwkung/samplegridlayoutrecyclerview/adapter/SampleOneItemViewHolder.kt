...
class SampleOneItemViewHolder(val view: View) : SampleGridAdapter.SampleGridViewHolder(view) {
    override fun bind(sampleGridModel: SampleGridModel) {
        itemView.apply {
            relativeLayout.setBackgroundColor(ContextCompat.getColor(context, R.color.colorItemOne))
